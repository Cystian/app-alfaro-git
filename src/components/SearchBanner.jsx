...
<section
  className="relative w-full min-h-[250px] bg-cover bg-center flex flex-col items-center justify-center py-8 sm:py-12 text-center"
      ...
      <div className="flex items-center space-x-2 mt-7 md:mt-0">
        ...
        >
          ...
          <span
            ...
            style={{
              backgroundImage: soloDisponibles
                ? "url('/check2.png')"
                : "none",
            }}
          />
