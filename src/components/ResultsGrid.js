...
// Este componente muestra todas las propiedades encontradas tras la búsqueda
// Cada tarjeta incluye contador, imagen, título, ubicación y precio
import React from "react";

export default function ResultsGrid({ properties }) {
  // Si no hay propiedades, no renderiza nada
    ...
    <section className="mb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {properties.map((prop, index) => (
          ...
          >
            {/* Contador de posición de la propiedad */}
