  ...
  return (
    <section className="relative bg-[#F9F9F9] py-20 px-6 md:px-20 overflow-hidden">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="relative max-w-6xl mx-auto bg-white shadow-xl rounded-3xl p-10 md:p-16 hover:shadow-2xl transition-all duration-500"
      >
        {/* Logo */}
        <img
          src="/logo.jpeg"
          alt="Logo Inmobiliaria Alberto Alfaro"
          className="mx-auto mb-10 w-44 md:w-52 h-auto object-contain"
        />

        {/* Título */}
        <h1 className="text-3xl md:text-4xl font-extrabold text-center text-[#C80000] mb-12 tracking-wide">
          Nuestra Historia
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-12">
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-700 text-base leading-relaxed">
                Inmueble compuesto por <strong>70 tiendas comerciales</strong>,
                símbolo del desarrollo empresarial y comercial de la ciudad.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-700 text-base leading-relaxed">
                ...
                <strong>casino, banco, 25 oficinas y 4 departamentos dúplex</strong>,
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-700 text-base leading-relaxed">
                <strong>KANKUN Tropical Disco, Boulevard Sur y Babilon Lounge</strong>,
                reconocidas marcas de entretenimiento y conciertos que marcaron
                tendencia en Chimbote.
              </p>
            </div>
          </motion.div>
        </div>

        {/* Sección sobre el fundador */}
        <div className="mt-16 text-gray-700 text-lg md:text-xl leading-relaxed space-y-6 text-justify">
          ...
          <p>
            ...
            creciendo gracias a la confianza de sus clientes y al compromiso con
            la excelencia.
          </p>
        </div>

        {/* Valores / trayectoria resumida */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-14 text-center">
          <div className="p-6 bg-[#FFF5F5] rounded-2xl shadow-sm hover:shadow-md transition">
            ...
            <p className="text-gray-600 text-sm mt-2">De experiencia integral</p>
          </div>
          <div className="p-6 bg-[#FFF5F5] rounded-2xl shadow-sm hover:shadow-md transition">
          ...
          <div className="p-6 bg-[#FFF5F5] rounded-2xl shadow-sm hover:shadow-md transition">
            ...
            <p className="text-gray-600 text-sm mt-2">En toda la región del Santa</p>
          </div>
        </div>
      </motion.div>
    </section>
