...
{/* Dimensiones */}
      ...
      <div className="flex items-center bg-gray-50 p-5 rounded-2xl shadow-md border border-gray-200 hover:shadow-lg transition-shadow duration-300">
        ...
        <div>
          ...
          <p className="font-semibold text-lg text-gray-800">
           Frente:   {data.property.frontera ? `${data.property.frontera} m` : "No especificado"}
          </p>
            <p className="font-semibold text-lg text-gray-800">
           Largo:   {data.property.largo ? `${data.property.largo} m` : "No especificado"}
          </p>
    ...
    <>
      ...
      {/* DORMITORIOS */}
<div className="flex items-center bg-gray-50 p-5 rounded-2xl shadow-md border border-gray-200 hover:shadow-lg transition-shadow duration-300">
  <FaBed className="text-red-600 mr-3 text-2xl" />
  <div>
    <p className="text-gray-500 text-sm">Dormitorios</p>
    <p className="font-semibold text-lg text-gray-800">
      {data.property.bedrooms ? data.property.bedrooms : "No especificado"}
    </p>
  </div>
</div>
...
{/* BAÑOS */}
<div className="flex items-center bg-gray-50 p-5 rounded-2xl shadow-md border border-gray-200 hover:shadow-lg transition-shadow duration-300">
  <FaBath className="text-red-600 mr-3 text-2xl" />
  <div>
    <p className="text-gray-500 text-sm">Baños</p>
    <p className="font-semibold text-lg text-gray-800">
      {data.property.bathrooms ? data.property.bathrooms : "No especificado"}
    </p>
  </div>
</div>
