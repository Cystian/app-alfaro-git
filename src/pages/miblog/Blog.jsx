...
const CategoryCard = ({ title, description, image, link }) => (
  ...
  >
    ...
    <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-6">
      ...
      <Link
        to={link}
        className="bg-[#DF011A] hover:bg-red-700 text-white px-6 py-2 rounded-full text-sm font-medium transition-all duration-200 no-underline hover:no-underline focus:no-underline active:no-underline"
      >
        Ver {title}
      </Link>
    </div>
...
// 💥 Página principal del Blog con soporte para subrutas
const Blog = () => {
  const location = useLocation();

  // Detecta si estás en la raíz (/blog) o en una subruta (/blog/noticias, /blog/articulos)
  ...
  return (
    ...
    <div className="mb-4">
        ...
        // 🔄 Si estás en una subruta, renderiza la vista interna
