      ...
      <div className="space-y-4 mt-6">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span className="text-gray-800 text-base md:text-lg"> albertoalfaro@</span>
              <span className="text-gray-800 text-base md:text-lg ml-[-8px]">inmobiliariaalbertoalfaro</span>
              <span className="text-gray-800 text-base md:text-lg ml-[-8px]">.com.pe</span>
        </div>
